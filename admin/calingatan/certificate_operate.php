        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>CERTIFICATE OPERATE STATUS</h2>
                        </div>
                        <div class="body">
                                    ...
                                    <tbody>
                                        <?php foreach ($operates as $row): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="operate_view_information.php?id=<?= $row['id'] ?>" class="btn bg-teal waves-effect" style="margin-bottom: 5px;">
