                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        <?php foreach ($certificates as $certificate): ?>
                                            <tr>
                                                <td><span style="text-transform: capitalize;"><?php echo htmlspecialchars($certificate['for_barangay']); ?></span></td>
                                                ...
                                                <td>
                                                    <a href="certificate_view_information.php?id=<?= $certificate['id'] ?>" class="btn bg-teal waves-effect" style="margin-bottom: 5px;">
