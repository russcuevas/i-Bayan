...
<body class="theme-teal">
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        <?php foreach ($business_trade as $business_trades): ?>
                                            <tr>
                                                <td><?php echo $business_trades['code'] ?></td>
                                                <td><?php echo $business_trades['name'] ?></td>
                                                <td>₱<?php echo $business_trades['price'] ?></td>
                                                <td>
                                                    <a href="update_business_clearance.php?id=<?php echo $business_trades['id']; ?>" class="btn bg-teal waves-effect" style="margin-bottom: 5px;">
                                                        <i class="fa-solid fa-pencil"></i> UPDATE
                                                    </a>
                                                    <a href="#" data-id="<?php echo $business_trades['id']; ?>"
                                                        class=" btn bg-teal waves-effect btn-delete" style="margin-bottom: 5px;">
    ...
    <script>
        $('.btn-delete').click(function(e) {
            e.preventDefault();
            var businessClearanceId = $(this).data('id');
            var deleteUrl = `delete_business_clearance.php?id=${businessClearanceId}`;
