                            ...
                            <form id="form_validation" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 pr-4">
                                        ...
                                        <div class="form-group form-float" style="margin-top: 30px;">
                                            <div class="form-line">
                                                <textarea style="padding: 5px;" name="mission" cols="30" rows="5" class="form-control" required></textarea>
                                        ...
                                        <div class="form-group form-float" style="margin-top: 30px;">
                                            <div class="form-line">
                                                <textarea style="padding: 5px;" name="vision" cols="30" rows="5" class="form-control" required></textarea>
